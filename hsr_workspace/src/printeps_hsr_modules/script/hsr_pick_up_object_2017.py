...
(PET, MENU,CART, TABLE1,TABLE2,TABLE3,TABLE4,WAGON)    = range(0, 8)   # ペットボトル、メニュー、 カート、テーブル
...
TF_OBJECT   = ['ar_marker/10', 'ar_marker/10','ar_marker/9', 'ar_marker/12','ar_marker/13','ar_marker/8','ar_marker/9','hsr_wagon_tf']    # つかむ物体のtf: ペットボトル、メニュー(棚)# 物体を置く場所のtf
...
TARGET_POSE[WAGON][no1][PICKUP][BEFORE]     = geometry.pose(x=-0.07,y=-0.05-PetHeight-0.02, z=0.10,ei=-math.pi/2.0,ej=0, ek=-math.pi/2.0)   # テーブルの手前0.12[m],z軸回に-90[deg]回転させた姿勢
TARGET_POSE[WAGON][no1][PICKUP][CONTACT]    = geometry.pose(x=-0.05, z=0.09)
#TARGET_POSE[CART][no1][PICKUP][CONTACT]    = geometry.pose(x=0.12,y=-0.10, z=0.20, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
TARGET_POSE[WAGON][no1][PICKUP][AFTER]      = geometry.pose(x=0.20, z=-0.15)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢

#2
TARGET_POSE[WAGON][no2][PICKUP][BEFORE]     = geometry.pose(x=-0.07,y=-0.05-PetHeight-0.02, z=-0.10,ei=-math.pi/2.0,ej=0, ek=-math.pi/2.0)  # #ｘ奥行き+が奥ｙ高さ＋が上ｚ横＋が左
TARGET_POSE[WAGON][no2][PICKUP][CONTACT]    = geometry.pose(x=-0.05, z=0.09)
#TARGET_POSE[CART][no2][PICKUP][CONTACT]    = geometry.pose(x=0.27,y=-0.10, z=0.20, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
TARGET_POSE[WAGON][no2][PICKUP][AFTER]      = geometry.pose(x=0.20, z=-0.15)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢

#3
TARGET_POSE[WAGON][no3][PICKUP][BEFORE]     = geometry.pose(x=-0.17,y=-0.05-PetHeight-0.02, z=0.10,ei=-math.pi/2.0,ej=0, ek=-math.pi/2.0)  # #ｘ奥行き+が奥ｙ高さ＋が上ｚ横＋が左
TARGET_POSE[WAGON][no3][PICKUP][CONTACT]    = geometry.pose(x=-0.05, z=0.09)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
#TARGET_POSE[CART][no3][PICKUP][CONTACT]    = geometry.pose(x=0.12,y=-0.10, z=0.06, ek=-math.pi/2.0) 
TARGET_POSE[WAGON][no3][PICKUP][AFTER]      = geometry.pose(x=0.1, z=-0.15)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢

#4
TARGET_POSE[WAGON][no4][PICKUP][BEFORE]     = geometry.pose(x=-0.17,y=-0.05-PetHeight-0.02, z=-0.10,ei=-math.pi/2.0,ej=0, ek=-math.pi/2.0) # #ｘ奥行き+が奥ｙ高さ＋が上ｚ横＋が左
TARGET_POSE[WAGON][no4][PICKUP][CONTACT]    = geometry.pose(x=-0.05, z=0.09)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
#TARGET_POSE[CART][no4][PICKUP][CONTACT]    = geometry.pose(x=0.27,y=-0.10, z=0.06, ek=-math.pi/2.0)
TARGET_POSE[WAGON][no4][PICKUP][AFTER]      = geometry.pose(x=0.1, z=-0.15)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢
