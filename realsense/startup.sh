...
roslaunch realsense2_camera rs_multiple_cameras.launch align_depth:=true camera1:=rs01 serial_no_camera1:=838212070676  camera2:=rs02 serial_no_camera2:=838212072328
