...
TF_OBJECT   = ['ar_marker/15','ar_marker/14','ar_marker/14', 'ar_marker/8','ar_marker/9','ar_marker/10','ar_marker/11','ar_marker/11','ar_marker/14','hsr_wagon_tf']   # つかむ物体のtf: ペットボトル、メニュー(棚)# 物体を置く場所のtf
...
if cart==0:
    ...
    #1
    TARGET_POSE[WAGON][no1][PLACE][BEFORE]     = geometry.pose(x=-0.07,y=-0.05-PetHeight-0.05, z=0.05, ek=-math.pi/2.0)   # テーブルの手前0.12[m],z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no1][PLACE][CONTACT]    = geometry.pose(x=-0.04, z=0.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    #TARGET_POSE[CART][no1][PLACE][CONTACT]    = geometry.pose(x=0.12,y=-0.10, z=0.18, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no1][PLACE][AFTER]      = geometry.pose(x=0.05, z=-0.07)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢2
    #2
    TARGET_POSE[WAGON][no2][PLACE][BEFORE]     = geometry.pose(x=0.07,y=-0.05-PetHeight-0.05, z=0.05, ek=-math.pi/2.0)   # テーブルの手前0.12[m],z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no2][PLACE][CONTACT]    = geometry.pose(x=-0.04, z=0.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    #TARGET_POSE[CART][no2][PLACE][CONTACT]    = geometry.pose(x=0.27,y=-0.10, z=0.18, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no2][PLACE][AFTER]      = geometry.pose(x=0.05, z=-0.07)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢

    #3
    TARGET_POSE[WAGON][no3][PLACE][BEFORE]     = geometry.pose(x=-0.07,y=-0.05-PetHeight-0.05, z=-0.05, ek=-math.pi/2.0)   # テーブルの手前0.12[m],z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no3][PLACE][CONTACT]    = geometry.pose(x=-0.04, z=0.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    #TARGET_POSE[CART][no3][PLACE][CONTACT]    = geometry.pose(x=0.12,y=-0.10, z=0.06, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no3][PLACE][AFTER]      = geometry.pose(x=0.05, z=-0.07)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢

    #4
    TARGET_POSE[WAGON][no4][PLACE][BEFORE]     = geometry.pose(x=0.07,y=-0.05-PetHeight-0.05, z=-0.05, ek=-math.pi/2.0)   # テーブルの手前0.12[m],z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no4][PLACE][CONTACT]    = geometry.pose(x=-0.04, z=0.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    #TARGET_POSE[CART][no4][PLACE][CONTACT]    = geometry.pose(x=0.27,y=-0.10, z=0.06, ek=-math.pi/2.0)     # テーブルの位置,z軸回に-90[deg]回転させた姿勢
    TARGET_POSE[WAGON][no4][PLACE][AFTER]      = geometry.pose(x=0.05, z=-0.07)     
...
TARGET_POSE[TABLE1][no1][PLACE][AFTER]      = geometry.pose(x=0.0, z=-0.4)                    # 物体を置いた後ハンドを0.08[m]上に移動させ、0.2[m]後退した姿勢
