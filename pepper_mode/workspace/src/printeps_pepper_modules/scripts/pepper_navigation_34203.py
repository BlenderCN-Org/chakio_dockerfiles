...
class PepperNavigation:
    ...
    def __init__(self):
        ...
        if self.use_virtual_object==True:
            ...
            '''
            # カウンター
            self.r_object[0].p_x    = 1.5
            self.r_object[0].p_y    = -1.5
            self.r_object[0].len_x  = 1.2
            self.r_object[0].len_y  = 1.0

            # テーブル1
            self.r_object[1].p_x    = 3.5
            self.r_object[1].p_y    = -1.5
            ...
            # テーブル3
            self.r_object[3].p_x    = 3.5
            self.r_object[3].p_y    = 2.0
            self.r_object[3].len_x  = 1.2
            self.r_object[3].len_y  = 1.6
            ...
            self.r_object[6].p_y    = 2.0
            self.r_object[6].len_x  = 3.0
            self.r_object[6].len_y  = 1.5
