...
echo_and_run cd "/catkin_ws/src/naoqi_bridge/naoqi_pose"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/catkin_ws/src/naoqi_bridge/naoqi_pose/setup.py" \
    build --build-base "/catkin_ws/build/naoqi_bridge/naoqi_pose" \
    install \
    $DESTDIR_ARG \
