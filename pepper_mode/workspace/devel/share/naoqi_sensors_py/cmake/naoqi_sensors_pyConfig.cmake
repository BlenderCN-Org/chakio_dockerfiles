...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_sensors_py_SOURCE_PREFIX /catkin_ws/src/naoqi_bridge/naoqi_sensors_py)
  set(naoqi_sensors_py_DEVEL_PREFIX /catkin_ws/devel)
  ...
  set(naoqi_sensors_py_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT "/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  ${_report}")
    endif()
