...
private:
    ...
    ros::Publisher pubT = _nh.advertise<geometry_msgs::PoseStamped> ("hsr_target", 1);
    ...
    double SearchRadius=1.4;
public:
    SetTarget()
    {
        sub_path = _nh.subscribe("/hsr_path",1,&SetTarget::getPath,this);
