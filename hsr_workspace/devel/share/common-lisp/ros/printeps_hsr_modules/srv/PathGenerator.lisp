...
(cl:defclass <PathGenerator-request> (roslisp-msg-protocol:ros-message)
  ((start
   ...
   (multimodalPathplanning
    :reader multimodalPathplanning
    :initarg :multimodalPathplanning
...
(cl:defmethod cl:initialize-instance :after ((m <PathGenerator-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathGenerator-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name printeps_hsr_modules-srv:<PathGenerator-request> is deprecated: use printeps_hsr_modules-srv:PathGenerator-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <PathGenerator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:start-val is deprecated.  Use printeps_hsr_modules-srv:start instead.")
  (start m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <PathGenerator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:goal-val is deprecated.  Use printeps_hsr_modules-srv:goal instead.")
  (goal m))

(cl:ensure-generic-function 'dynamicObstacle-val :lambda-list '(m))
(cl:defmethod dynamicObstacle-val ((m <PathGenerator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:dynamicObstacle-val is deprecated.  Use printeps_hsr_modules-srv:dynamicObstacle instead.")
  (dynamicObstacle m))

(cl:ensure-generic-function 'multimodalPathplanning-val :lambda-list '(m))
(cl:defmethod multimodalPathplanning-val ((m <PathGenerator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:multimodalPathplanning-val is deprecated.  Use printeps_hsr_modules-srv:multimodalPathplanning instead.")
  (multimodalPathplanning m))

(cl:ensure-generic-function 'voiceImportance-val :lambda-list '(m))
(cl:defmethod voiceImportance-val ((m <PathGenerator-request>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathGenerator-request>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'multimodalPathplanning) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathGenerator-request>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'multimodalPathplanning) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PathGenerator-request>)))
  ...
  "printeps_hsr_modules/PathGeneratorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathGenerator-request)))
  "Returns string type for a service object of type 'PathGenerator-request"
  "printeps_hsr_modules/PathGeneratorRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PathGenerator-request>)))
  ...
  "da86772c5496ba414c78c020ceee2035")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PathGenerator-request)))
  "Returns md5sum for a message object of type 'PathGenerator-request"
  "da86772c5496ba414c78c020ceee2035")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <PathGenerator-request>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'multimodalPathplanning))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PathGenerator-request>))
  ...
  (cl:list 'PathGenerator-request
    ...
    (cl:cons ':multimodalPathplanning (multimodalPathplanning msg))
...
(cl:defmethod cl:initialize-instance :after ((m <PathGenerator-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathGenerator-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name printeps_hsr_modules-srv:<PathGenerator-response> is deprecated: use printeps_hsr_modules-srv:PathGenerator-response instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <PathGenerator-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:path-val is deprecated.  Use printeps_hsr_modules-srv:path instead.")
  (path m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <PathGenerator-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader printeps_hsr_modules-srv:length-val is deprecated.  Use printeps_hsr_modules-srv:length instead.")
  (length m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PathGenerator-response>)))
  ...
  "printeps_hsr_modules/PathGeneratorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathGenerator-response)))
  "Returns string type for a service object of type 'PathGenerator-response"
  "printeps_hsr_modules/PathGeneratorResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathGenerator)))
  ...
  "printeps_hsr_modules/PathGenerator")