...
"""autogenerated by genpy from printeps_pepper_modules/PathGeneratorRequest.msg. Do not edit."""
import sys
...
class PathGeneratorRequest(genpy.Message):
  _md5sum = "948cdf81d7d93a5c3de293b29845ee7d"
  _type = "printeps_pepper_modules/PathGeneratorRequest"
...
float64 w
"""
  __slots__ = ['start','goal','dynamicObstacle']
  _slot_types = ['geometry_msgs/Pose2D','geometry_msgs/Pose2D','geometry_msgs/PoseArray']
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from printeps_pepper_modules/PathGeneratorResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PathGeneratorResponse(genpy.Message):
  ...
  _type = "printeps_pepper_modules/PathGeneratorResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class PathGenerator(object):
  _type          = 'printeps_pepper_modules/PathGenerator'
  _md5sum = '3a7361f4077151c10d6f43ed28f73c44'
