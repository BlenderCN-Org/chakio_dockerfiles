...
echo_and_run cd "/catkin_ws/src/naoqi_bridge/naoqi_sensors_py"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/catkin_ws/src/naoqi_bridge/naoqi_sensors_py/setup.py" \
    build --build-base "/catkin_ws/build/naoqi_bridge/naoqi_sensors_py" \
    install \
    $DESTDIR_ARG \
