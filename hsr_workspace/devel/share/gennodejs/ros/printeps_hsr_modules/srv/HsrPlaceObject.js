...
class HsrPlaceObjectRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type HsrPlaceObjectRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type HsrPlaceObjectRequest
    let len;
    let data = new HsrPlaceObjectRequest(null);
  ...
  static datatype() {
    ...
    return 'printeps_hsr_modules/HsrPlaceObjectRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HsrPlaceObjectRequest(null);
...
class HsrPlaceObjectResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type HsrPlaceObjectResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type HsrPlaceObjectResponse
    let len;
    let data = new HsrPlaceObjectResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'printeps_hsr_modules/HsrPlaceObjectResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HsrPlaceObjectResponse(null);
...
module.exports = {
  Request: HsrPlaceObjectRequest,
  Response: HsrPlaceObjectResponse,
  md5sum() { return '2699cab027d5696828aa7d5692db4bfe'; },
  datatype() { return 'printeps_hsr_modules/HsrPlaceObject'; }
};
